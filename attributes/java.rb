default['ud-macapps']['java']['dmg']['source']      = "http://support.apple.com/downloads/DL1572/en_US/JavaForOSX2013-05.dmg"
default['ud-macapps']['java']['dmg']['volumes_dir'] = "Java for OS X 2013-005"
default['ud-macapps']['java']['dmg']['checksum']    = "81e1155e44b2c606db78487ca1a02e31dbb3cfbf7e0581a4de3ded9e635a704e"

default['ud-macapps']['java']['additional'] = {
