...
remote_file "#{Chef::Config[:file_cache_path]}/G2WMT_Global&US_v6.0_b1259.zip" do
...
execute "unzip-gtm" do
  command "unzip #{Chef::Config[:file_cache_path]}/G2WMT_Global&US_v6.0_b1259.zip -d #{Chef::Config[:file_cache_path]}"
  action :nothing
end

dmg_package "GoToMeeting" do
  source "file://#{Chef::Config[:file_cache_path]}/G2WMT_Global&US_v6.0_b1259.dmg"
